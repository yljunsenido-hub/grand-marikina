...
export default function Contact() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-900">
      ...
      <form action={submitInquiry} className="flex flex-col gap-4 w-full max-w-md">
        ...
        <button type="submit" className="bg-white text-black font-bold py-3 rounded hover:bg-gray-200 transition">
          Send Inquiry
        </button>
      </form>
    </main>
